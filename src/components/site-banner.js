...
const SiteBanner = () => {
	return (
		<div
			id={`banner`}
			className={`relative w-full h-16 desktop:h-24 bg-gray-800 border-r border-l border-primary z-40`}
		>
			<div className={`relative w-full h-full overflow-hidden`}>
				...
				<div
					...
					className={`relative h-full w-1/3 tablet:w-72 mx-auto`}
				>
					<SpinningCog
					...
					<SpinningCog
						...
						cogClassName={`text-4xl tablet:text-8xl text-primary-3 animate-spin-slow-left`}
					/>
					<SpinningCog
