...
const AffinityCard = ({
	...
	return (
		<div className={`relative flex flex-col h-54 w-full items-center text-center bg-gray-800 p-6 rounded-3xl border border-gray-700 max-w-400px mx-auto tablet:m-0`}>
