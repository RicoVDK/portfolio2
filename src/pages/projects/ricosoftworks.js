	...
	return (
		<ProjectLayout projectId={`entry-portfolio`}>
			...
			<TextCenter>
				...
				<br/>
				Having established the basic necessities for my website, it's time to split them up into smaller components and think about what I will use to make them.<br/>
				<br/>
				<TextSubTitle id={`the-plan`} className={`py-4`}>
					The Plan
				</TextSubTitle><br/>
				<br/>
				So now that I know what I want to make, it's time to determine a deadline.<br/>
			...
			<TextCenter>
				...
				like one for styling text into a title, a subtitle, or making it a link, and so on!<br/>
				<br/>
				I wanted to structure the about page in 3 parts, where it's ordened from quick and shortened information to lengthier.<br/>
				...
				Afterward, if people <TextBold>are still interested</TextBold>, they can see my entire experience history below that.<br/>
